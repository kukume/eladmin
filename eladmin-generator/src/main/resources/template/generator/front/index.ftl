...
import rrrOperation from '@crud/RRR.operation'
...
export default {
  name: '${className}',
  components: { pagination, crudOperation, rrrOperation, udOperation },
