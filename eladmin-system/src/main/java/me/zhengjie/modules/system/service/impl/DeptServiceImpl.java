...
public class DeptServiceImpl implements DeptService {
    ...
    public List<Dept> queryAll(DeptQueryCriteria criteria, Boolean isQuery) throws Exception {
        ...
        List<Dept> list = deptRepository.findAll((root, criteriaQuery, criteriaBuilder) -> QueryHelp.getPredicate(root,criteria,criteriaBuilder),sort);
    ...
    public Object buildTree(List<Dept> deptDtos) {
        ...
        List<String> deptNames = deptDtos.stream().map(Dept::getName).toList();
        boolean isChild;
        for (Dept deptDTO : deptDtos) {
            isChild = false;
            if (deptDTO.getPid() == null) {
    ...
    public void verification(Set<Dept> deptDtos) {
        Set<Long> deptIds = deptDtos.stream().map(Dept::getId).collect(Collectors.toSet());
